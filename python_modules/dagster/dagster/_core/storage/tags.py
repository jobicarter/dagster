...
RETRY_ON_START_TIMEOUT_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_start_timeout"
RETRY_ON_UNEXPECTED_TERMINATION_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_unexpected_termination"
